    ...
    <div id="cl-wrapper" class="login-container">
        <div class="middle-login">
            <div class="block-flat">
                <div class="header">
                    <h3 class="text-center"><img class="logo-img" src="<?php echo base_url();?>/assets/<?php echo $web->identitas_favicon;?>" alt="logo"
                        /></h3>
                </div>
                <div>
                    <form style="margin-bottom: 0px !important;" class="form-horizontal" action="<?php echo site_url();?>wp_login/ceklogin" method="post" name="formLogin" id="form" parsley-validate novalidate>
                        <div class="content">
                            ...
                            <div class="form-group input-group-lg">
                                <div class="col-sm-12">
                                    <input type="text" name="username" id="user" required class="form-control" onblur="clearText(this)" onfocus="clearText(this)"
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <input type="password" name="password" id="pass" required class="form-control" onblur="clearText(this)" onfocus="clearText(this)"
            ...
            <div class="text-center out-links">Belum punya akun? Daftar terlebih dahulu</div>
            <div class="center">
                <a href="<?php echo site_url();?>pages" class="btn btn-primary button-produk"><i class="fa fa-shopping-cart"></i> Kembali lihat Produk</a>                <a href="<?php echo site_url();?>register" class="btn btn-primary button-daftar">Daftar</a>
            </div>
        </div>
    </div>
