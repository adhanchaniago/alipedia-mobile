...
<div class="cl-mcont" style="margin-top: 0px !important">
    <div class='row'>
        ...
        <?php         
        if ($jml_data2 > 0){
	        foreach ($this->ADM->grid_all_kategori('', 'kategori_jenis', 'ASC', $batas2, '', '', '') as $row){
        ?>
        <div class="col-xs-6">
            <div class="block-flat">
                <a href="<?php echo site_url();?>pages/kategori/detail/<?php echo $row->kategori_id;?>">
                    <div class="judul">
        ...
        ?>
        <div class="col-xs-12 col-md-12">
            <div class="title"> Semua Produk </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12">
            <div class="block-flat">
                <div class="content">
                    <form action="<?php echo base_url();?>pages/produk" method="post" id="form">
                        <div class='btn-navigation'>
                            <div class='pull-right'>
                                <a class="btn btn-primary" href="<?php echo site_url();?>pages/produk"><i class="fa fa-times-circle"></i> Bersihkan Pencarian</a>
                            </div>
                        </div>
                        <div class='row'>
            ...
            <div class="row">
                <?php
	                $like_produk[$cari]			= $q;
	                if ($jml_data > 0){
	                    foreach ($this->ADM->grid_all_produk('', 'produk_id', 'DESC', $batas, $page, '', $like_produk) as $row){
	                ?>
                    <div class="col-xs-12 col-sm-6 col-md-6">
                        <div class="block-flat">
                            <div class="content">
                                ...
                                Rp<?php echo number_format($row->produk_harga,0,',','.') ?>,00
                                </div>
                                ...
                                <?php if ($row->produk_stock > 0) { ?>
                                    <a style="margin-top: 10px" class="btn btn-primary btn-block btn-produk btn-sm" data-toggle="modal" data-target="#mod-info" type="button" href="<?php echo site_url();?>pages/produk_beli/<?php echo $row->produk_id;?>" rel="detail" title="Detail <?php echo $row->produk_nama; ?>"><i class="fa fa-shopping-cart"></i> Beli</a>
                                <?php } else { ?>
            ...
            <div class="block-flat">
                <div id='pagination'>
                    ...
                    <div class='pagination-right'>
                        <ul class="pagination">
                            <?php if ($jml_halaman > 1) { echo pages($halaman, $jml_halaman, 'pages/produk/view', $id=""); }?>
                        </ul>
                    </div>
                </div>
            </div>
...
<form role="form" class="form-horizontal" action="<?php echo site_url();?>pages/produk_beli/<?php echo $produk->produk_id; ?>"
